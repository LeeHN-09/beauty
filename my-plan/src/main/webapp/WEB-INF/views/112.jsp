		...
		<div class="main-content" id="mainContent">
			...
			<div class="tab-content" id="tab1">
				<form action="/add1" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group">
						<label for="salesQuantity">銷量</label> <input type="number"
							class="form-control" id="sales_quantity" name="sales_quantity"
							min="0">
					</div>
			...
			<div class="tab-content" id="tab2">
				...
				<form action="/renew" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group">
						<label for="edit_sales_quantity">銷量</label> <input type="number"
							class="form-control" id="edit_sales_quantity"
							name="edit_sales_quantity" min="0">
					</div>
